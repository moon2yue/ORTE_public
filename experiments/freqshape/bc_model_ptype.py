...
from txai.utils.recording import set_time, set_seed, PrintToLogger
...
def main(args, formstyleTime):
    ...
    for i in range(1,6):
        ...
        spath = os.path.join('', model_suffix)
...
if __name__ == '__main__':
    ...
    ablations.add_argument('--lstm', action = 'store_true', default=True)
    ablations.add_argument('--cnn', action = 'store_true', default=False)
    ...
    parser.add_argument('--sparse_lw', type = float, default = 0.005, help = 'sparse_loss_weight')
