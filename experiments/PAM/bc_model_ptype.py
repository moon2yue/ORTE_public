...
def main(args, formstyleTime):
    ...
    for i in range(1, 6):
        trainPAM, val, test = process_PAM(split_no = i, device = device, base_path = '', gethalf = True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sparse_lw', type = float, default = 0.001, help = 'sparse_loss_weight')
