...
def main(args, formstyleTime):
    ...
    if args.lstm:
        arch = 'lstm'
        tencoder_path = "./models/Scomb_lstm_split={}.pt"
    elif args.cnn:
        arch = 'cnn'
        tencoder_path = "./models/Scomb_cnn_split={}.pt"
    else:
        arch = 'transformer'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cont_lw_first', type = float, default = 5, help = 'first_layer: cont_loss_weight')
    parser.add_argument('--cont_lw_last', type = float, default = 10.0, help = 'last_layer: cont_loss_weight')
    parser.add_argument('--sparse_lw', type = float, default = 0.05, help = 'sparse_loss_weight')
    parser.add_argument('--sim_lw', type = float, default = 0, help = 'similar_loss_mse_weight')
