...
def main(args):
    ...
    if Dname == 'freqshape':
        ...
        D = process_Synth(split_no = args.split_no, device = device, base_path = '')
    ...
    #     D = process_Yahoo(split_no = args.split_no, device = device, balance = False)
        ...
        trainEpi, val, test = process_PAM(split_no = args.split_no, device = device, base_path = '', gethalf = True)
    elif Dname == 'irreg':
