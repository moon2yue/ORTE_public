...
if __name__ == '__main__':
    ...
    ablations.add_argument('--simclr', action = 'store_true', help = 'Uses SimLR loss instead of consistency loss')
    ...
    parser.add_argument('--r', type = float, default = 0.1, help = 'r for GSAT loss')
    ...
    parser.add_argument('--cont_lw_first', type = float, default = 0.5, help = 'first_layer: cont_loss_weight')
    ...
    parser.add_argument('--sim_lw', type = float, default = 2, help = 'similar_loss_mse_weight')
    parser.add_argument('--kl_lw', type=float, default=0, help='kl_loss_mse_weight')
    parser.add_argument('--decoupled_ste', type = bool, default = False, help = 'use decoupled forward and backward weight')
